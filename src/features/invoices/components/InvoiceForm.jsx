      ...
      <Card>
        <CardContent className="pt-6">
          <div className="space-y-1.5">
            ...
            <textarea
              className="flex min-h-[80px] w-full rounded-lg border border-gray-200 bg-gray-100/60 px-3 py-2 text-sm text-gray-900 shadow-sm placeholder:text-gray-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 resize-none"
