  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <p className="font-mono text-[10px] uppercase tracking-[0.22em] text-blue-400/80">// proveedores</p>
          <h1 className="text-2xl font-bold text-gray-900 mt-1">Proveedores</h1>
